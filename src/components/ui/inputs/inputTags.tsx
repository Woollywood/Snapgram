...
export type InputProps = React.InputHTMLAttributes<HTMLInputElement> & { onUpdate?: (tags: string[]) => void };

export const InputTags = forwardRef<HTMLInputElement, InputProps>(({ className, type, onUpdate, ...props }, ref) => {
